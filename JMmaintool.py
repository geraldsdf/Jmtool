...
from jmtool import geraldsdf

__CHANNEL_USERNAME__ = "𝙹𝙼𝙶𝙰𝚁𝙰𝙶𝙴 𝚃𝙾𝙾𝙻 𝙲𝙷𝙰𝙽𝙽𝙴𝙻"
__GROUP_USERNAME__   = "𝙹𝙼𝙶𝙰𝚁𝙰𝙶𝙴 𝚃𝙾𝙾𝙻 𝙳𝙸𝚂𝙲𝚄𝚂𝚂𝙸𝙾𝙽"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{30}: Custom Car Millage             2.5k'))
            print(Colorate.Horizontal(Colors.rainbow, '{31}: Custom Car Brake             2.5k'))
